 ...
 */
#define USE_CONTROLLER_FAN                  // Using the HE1 port
...
// @section bltouch
  ...
  //#define BLTOUCH_DELAY 300 //500 //for later
   ...
   */
  //#define BLTOUCH_HS_MODE true //for later
...
#define BABYSTEPPING
  ...
  //#define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement). // Unavailable on LPC1768
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping.
    ...
    //#define MOVE_Z_WHEN_IDLE              // Jump to the move Z menu on doubleclick when printer is idle. // Unavailable on LPC1768
